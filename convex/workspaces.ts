...
const generateCode = () => {
    ...
    return Array.from({length: 6}, () => "0123456789abcdefghijklmnopqrstuvxyz"[Math.floor(Math.random() * 36)]).join("");
...
export const create = mutation({
    ...
    handler: async (ctx, args) => {
        ...
        // to add a general channel by default uncomment the part above
